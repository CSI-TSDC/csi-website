          ...
          <div className="relative z-10 p-5 sm:p-6 md:p-8 lg:p-12 flex flex-col items-center justify-center min-h-[280px] sm:min-h-[320px] md:min-h-[360px]">
            ...
            <div className="text-center px-2 sm:px-0">
              ...
              <div className="flex items-center justify-center gap-2 sm:gap-3 md:gap-4 mb-4 sm:mb-5 md:mb-6 lg:mb-8 flex-wrap">
                ...
                <a
                  href="https://maps.app.goo.gl/K3DfqSCF7RoN5kcu9"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-1.5 sm:gap-2 hover:text-white transition-colors duration-200 group"
                >
                  ...
                  <span className="text-white/90 font-medium font-bespoke-sans uppercase text-xs sm:text-sm md:text-base group-hover:text-white underline underline-offset-2 decoration-white/50 group-hover:decoration-white transition-all">At TSDC</span>
                </a>
              </div>

              <p className="text-white/80 text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-bespoke-sans uppercase leading-relaxed px-2 mb-6">
