  ...
  return (
    <div className="min-h-screen bg-[#f8f8f8]">
      ...
      <section className="px-6 pb-20 pt-32 md:pb-28 md:pt-40 w-full gallery-bg">
        ...
        <div className="grid mx-auto max-w-6xl md:grid-cols-[1.15fr_1fr] gap-10 items-center">
          ...
          <div className="absolute right-0 top-1/2 -translate-y-1/2 space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <img
                ...
                className="w-[220px] h-[120px] object-cover rounded-2xl"
              />
            </div>

            {/* Row 2 */}
            <div className="flex gap-4 translate-x-14">
              <img
                src="https://images.unsplash.com/photo-1519389950473-47ba0277781c"
                className="w-[180px] h-[145px] object-cover rounded-2xl"
              />
              <img
                src="https://images.unsplash.com/photo-1581090700227-1e37b190418e"
                className="w-[240px] h-[145px] object-cover rounded-2xl"
              />
              <img
                src="https://images.unsplash.com/photo-1600880292089-90a7e086ee0c"
                className="w-[150px] h-[145px] object-cover rounded-2xl"
              />
            </div>
            ...
            <div className="flex gap-4 translate-x-6">
              <img
                ...
                className="w-[210px] h-[135px] object-cover rounded-2xl"
              />
              <img
                src="https://images.unsplash.com/photo-1551434678-e076c223a692"
                className="w-[260px] h-[135px] object-cover rounded-2xl"
              />
              <img
                src="https://images.unsplash.com/photo-1553877522-43269d4ea984"
                className="w-[190px] h-[135px] object-cover rounded-2xl"
              />
            </div>
