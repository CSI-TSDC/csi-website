...
// Load photos from manifest (generated by generateGalleryManifest.js)
...
export default function Gallery() {
  ...
  const handleYearChange = useCallback((year) => {
    ...
    // Preserve loaded state for images that will still be visible
    // Only reset for images that won't be in the new filter
    setImagesLoaded(prev => {
      const newState = {};
      photos.forEach(photo => {
        const willBeVisible = (year === "All" || photo.year === year);
        if (willBeVisible && prev[photo.id]) {
  ...
  // Handle image error - hide failed images
